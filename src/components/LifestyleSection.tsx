...
import { BookOpen, Users, Heart, Globe, Coffee, Star } from "lucide-react";
  ...
  return (
    <section ref={sectionRef} id="lifestyle" className="py-20 bg-gradient-to-b from-black via-gray-900 to-black min-h-screen relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <motion.h2 
            className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-white via-white to-accent-gold bg-clip-text text-transparent"
            initial={{ opacity: 0, scale: 0.9 }}
            whileInView={{ opacity: 1, scale: 1 }}
            transition={{ duration: 0.8, delay: 0.2 }}
          >
            Values & <span className="text-accent-gold">Lifestyle</span>
          </motion.h2>
          <motion.p 
          ...
          {values.map((value, index) => {
            ...
            return (
              <motion.div
                ...
                className={`group relative overflow-hidden bg-gradient-to-br ${value.gradient} backdrop-blur-sm border border-white/20 rounded-2xl p-6 hover:shadow-2xl hover:border-white/30 transition-all duration-300`}
              >
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            ...
            <motion.div 
              className="relative overflow-hidden bg-gradient-to-br from-accent-gold/10 to-accent-gold/5 backdrop-blur-sm border border-accent-gold/20 rounded-2xl p-8 hover:shadow-2xl transition-all duration-300"
              whileHover={{ y: -5 }}
              transition={{ type: "spring", stiffness: 300 }}
            >
              <motion.h3 
              ...
              <div className="grid grid-cols-1 gap-4">
                {interests.map((interest, index) => (
                  <motion.div 
                    key={index} 
                    className="flex items-center gap-4 p-4 bg-white/5 backdrop-blur-sm rounded-xl hover:bg-white/10 transition-all duration-300 group"
                  ...
                  >
                    <motion.div 
                      className="w-3 h-3 bg-accent-gold rounded-full flex-shrink-0 group-hover:scale-125 transition-transform duration-300" 
        ...
        >
          ...
          >
            ...
            <div className="relative z-10">
              ...
              >
                "Success is not just about what you accomplish, but about the positive 
                impact you have on others and the legacy you create."
              </motion.blockquote>
              <motion.footer 
